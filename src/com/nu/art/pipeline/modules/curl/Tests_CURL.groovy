...
class Tests_CURL
  ...
  TestSuite collectTests() {
    TestCase testCase1 = new TestCase("Simple", Consts.Test1_Expected, {
      return new CURL_Request("https://my-domain.com/v1/do-something")
...
class Consts {
  ...
  public static String Test2_Expected = """curl -X GET -H "Content-Type: application/json" -H "x-application: my-application" -o /tmp/output -s -w '%{http_code}' https://my-domain.com/v1/do-something"""
}
